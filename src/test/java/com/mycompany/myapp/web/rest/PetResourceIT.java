...
public class PetResourceIT {
    ...
    public void createPet() throws Exception {
        ...
        // Create the Pet
        restPetMockMvc.perform(post("/api/pets").with(csrf())
    ...
    public void updatePet() throws Exception {
        ...
        restPetMockMvc.perform(put("/api/pets").with(csrf())
            .contentType(MediaType.APPLICATION_JSON)
    ...
    public void deletePet() throws Exception {
        ...
        // Delete the pet
        restPetMockMvc.perform(delete("/api/pets/{id}", pet.getId()).with(csrf())
