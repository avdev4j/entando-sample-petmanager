...
class PetDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'pet.details.';
    ...
    const ReactComponent = React.createElement(PetDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('pet-details', PetDetailsElement);
