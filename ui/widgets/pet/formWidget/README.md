...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/pet/formWidget/>):
    1. Run `npm i`
...
-   **pet.form.createError** (fired when an error occurs during pet creation)
-   **pet.form.create** (fired when the pet is successfully created)
-   **pet.form.updateError** (fired when an error occurs during pet update)
-   **pet.form.update** (fired when the pet is successfully updated)
