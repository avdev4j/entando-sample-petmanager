...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/pet/tableWidget/>):
    1. Run `npm i`
...
-   **pet.table.error** (fired when an error occurs)
-   **pet.table.select** (fired when a table row is selected)
