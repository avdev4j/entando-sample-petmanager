...
class TypeDetailsElement extends HTMLElement {
  constructor(...args) {
    super(...args);
  ...
  render() {
    const customEventPrefix = 'type.details.';
    ...
    const ReactComponent = React.createElement(TypeDetailsContainer, {
      id,
      onError,
      serviceUrl,
    });
...
customElements.define('type-details', TypeDetailsElement);
