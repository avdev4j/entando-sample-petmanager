...
1. Go to widget source (<MICROSERVICE_FOLDER>/ui/widgets/type/tableWidget/>):
    1. Run `npm i`
...
-   **type.table.error** (fired when an error occurs)
-   **type.table.select** (fired when a table row is selected)
